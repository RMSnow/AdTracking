...
def lgb_modelfit_nocv(params, dtrain, predictors, target='target', objective='binary', metrics='auc',
    ...
    estimators = lgb.train(lgb_params,
                     xgtrain,
                     valid_sets=xgtrain,
...
print('load train...')
train_df = pd.read_csv(path+"train.csv", nrows=1000000, dtype=dtypes, usecols=['ip','app','device','os', 'channel', 'click_time', 'is_attributed'])
print('load test...')
